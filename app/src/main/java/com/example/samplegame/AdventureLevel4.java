...
//                    @Override
//                    public void run() {
//                        translate(knight, node4);
//                    }
//                }, 2000);
//                if(strInputLower.charAt(2) == 'b'){
//                    handler.postDelayed(new Runnable() {
//                        @Override
//                        public void run() {
